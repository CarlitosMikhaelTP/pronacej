...
public class ResultadosProgramasCjdr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.textViewparticipa_programa_unoPorcentaje)).setText(String.format("%.2f%%", porcentajeUno));
        ((TextView) findViewById(R.id.textViewparticipa_programa_uno)).setText("Programa uno");
        ...
        ((TextView) findViewById(R.id.textViewparticipa_programa_cincoPorcentaje)).setText(String.format("%.2f%%", porcentajeCinco));
        ((TextView) findViewById(R.id.textViewparticipa_programa_cinco)).setText("Programa cinco");
